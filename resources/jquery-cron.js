    ...
    var methods = {
        init : function(opts) {
            ...
            block["period"] = $("<span class='cron-period'>"
                    + "<div class='col-md-12'>Every <select name='cron-period' class='form-control'>" + custom_periods
                    + str_opt_period + "</select></div> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["dom"] = $("<span class='cron-block cron-block-dom'>"
                    + " <div class='col-md-12'>on the <select name='cron-dom' class='form-control'>" + str_opt_dom
                    + "</select></div> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["month"] = $("<span class='cron-block cron-block-month'>"
                    + " <div class='col-md-12'>of <select name='cron-month' class='form-control'>" + str_opt_month
                    + "</select></div> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["mins"] = $("<span class='cron-block cron-block-mins'>"
                    + " <div class='col-md-12'>at <select name='cron-mins' class='form-control'>" + str_opt_mih
                    + "</select> minutes past the hour </div></span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["dow"] = $("<span class='cron-block cron-block-dow'>"
                    + " <div class='col-md-12'>on <select name='cron-dow' class='form-control'>" + str_opt_dow
                    + "</select></div> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["time"] = $("<span class='cron-block cron-block-time'>"
                    + "<div class='col-md-12'>at</div>" 
                    + "<div class='col-md-2'><select name='cron-time-hour' class='cron-time-hour form-control'>" + str_opt_hid
                    + "</select></div><div class='col-md-1'>:</div><div class='col-md-2'><select name='cron-time-min' class='cron-time-min form-control'>" + str_opt_mih
                    + " </div></span>")
                .appendTo(this)
                .data("root", this);
